...
namespace Awesome9\Requirements\Test;
...
class TestRequirements extends \WP_UnitTestCase {
	...
	public function test_register_checker_should_throw_exception_if_checker_already_registered() {
		$requirements = new Requirements( 'Test', [ 'php' => '7' ], false );
		$requirements->register_checker( 'Awesome9\Requirements\Checker\PHP' );
		$requirements->register_checker( 'Awesome9\Requirements\Checker\PHP' );
	}

	public function test_register_checker_should_register_checker_and_return_requirements() {
		$requirements = new Requirements( 'Test', [ 'php' => '7' ], false );
		$returned     = $requirements->register_checker( 'Awesome9\Requirements\Checker\PHP' );
	...
	public function test_get_checker_should_return_false() {
		$class_name   = 'Awesome9\Requirements\Checker\PHP';
		$requirements = new Requirements( 'Test', [], false );
		$requirements->register_checker( $class_name );
		$this->assertFalse( $requirements->get_checker( 'php' ) );
	}
}
